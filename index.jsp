			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="rate.html"><i class="icon-signal"></i><span class="hidden-tablet"> 赔率</span></a></li>
						<li><a class="ajax-link" href="match.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> 比赛</span></a></li>
